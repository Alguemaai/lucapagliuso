...
export const projects: Project[] = [
  ...
  },
  {
    ...
    index: "03",
    client: "Mustela",
    title: "From Birth · +2.3 Brand Lift",
    category: "Brand",
    year: "2024",
    tags: ["Full-Funnel", "BDI / CDI", "Brand Lift"],
    metrics: [
      { label: "Budget", value: "R$600K" },
      { label: "Brand Lift", value: "+2.3" },
      { label: "Channels", value: "5" },
    ],
    summary: "R$600K full-funnel launch that delivered Mustela's highest brand-lift study on record.",
    description: [
  ...
  },
  {
    ...
    title: "Luxury Social System",
    category: "Brand",
    year: "2024",
    tags: ["Creative", "Social", "Real Estate"],
    metrics: [
      { label: "Listings", value: "20+" },
      { label: "Format", value: "IG · Reels" },
      { label: "Slides", value: "6 / post" },
    ],
    summary: "Editorial social-asset system for one of São Paulo's leading luxury real-estate brokers.",
    description: [
